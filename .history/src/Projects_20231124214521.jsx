    ...
    <div className="Projects">
      ...
      <Project 
       title = "Ahinke's Kitchen"
        description = "Ahinkes' Kitchen is a local business that runs in the Forest Lawn area of Calgary. During the period of September 2023 and December 2023, I was hired as a web developer intern with the task of maintaining Ahinke's site through SquareSpace. This got me very familiar with Sqaure as a tool while, allowing me to learn how to work in a dynamic team environment. Through this process I also learned various plugins that are used in a business setting for websites, such as google plugins and others."  
      ...
      />
        ...
        description = "This assignment for my advanced data structures class was an assignment made with the goal of implementing hash maps. This assignment involves finding an appropriate key for a word puzzle. It was a very complex assignment which I received an A on and required a deep understanding of advanced data structures using Java."
        tags={["Java", "Teamwork"]}
